# DEPRECATED Script (Archived): scripts/build/delete_dead_code.sh

Do NOT run. Archived on 2025-11-06 to prevent accidental destructive deletions. This script was a bulk-deletion utility and is not referenced by builds.
