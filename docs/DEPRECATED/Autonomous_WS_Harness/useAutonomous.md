# DEPRECATED (Test Harness): src/hooks/useAutonomous.js

Do NOT use in production. Archived on 2025-11-06. Reason: WebSocket autonomous test harness; production uses SSE via services/api.js and AppleFloatBar.

## Original Source

```js
/* BEGIN ORIGINAL FILE: src/hooks/useAutonomous.js */
/**
 * useAutonomous Hook
 * 
