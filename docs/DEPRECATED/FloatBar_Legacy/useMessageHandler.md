# DEPRECATED: src/components/FloatBar/useMessageHandler.js

Do NOT use. Archived on 2025-11-06. Reason: Part of legacy FloatBar stack; uses mock API and `conversationSummary.js` with hardcoded localhost.

## Original Source

```js
/* BEGIN ORIGINAL FILE: src/components/FloatBar/useMessageHandler.js */
/**
