# DEPRECATED: src/components/FloatBar/FloatBarCore.jsx

Do NOT use. Archived on 2025-11-06. Reason: Replaced by AppleFloatBar with richer SSE/plan/exec UX and IPC integration; this was a prototype not routed by main.

## Original Source (for reference)

```jsx
/* BEGIN ORIGINAL FILE: src/components/FloatBar/FloatBarCore.jsx */
/**
