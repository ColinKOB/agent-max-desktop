...
export function OnboardingFlow({ onComplete, onSkip }) {
  ...
  const steps = [
    ...
    { id: 'subscription', title: 'Choose Your Plan', component: SubscriptionStep },
...
/**
 * Subscription plans for onboarding
 */
const SUBSCRIPTION_TIERS = [
  {
    ...
    yearlyPrice: 100,
    creditsPerWeek: 150,
    features: ['150 credits/week', 'Basic support', 'Core features']
  },
  {
    id: 'premium',
    name: 'Premium',
    ...
    creditsPerWeek: 400,
    popular: true,
    features: ['400 credits/week', 'Priority support', 'All integrations', 'Memory features']
  },
  {
    id: 'pro',
    name: 'Pro',
    ...
    yearlyPrice: 300,
    creditsPerWeek: 600,
    features: ['600 credits/week', 'Fastest responses', 'Dedicated support', 'Custom workflows']
  }
];
...
function SubscriptionStep({ userData, onNext, onBack }) {
  ...
  const handleSubscribe = async (tierId) => {
    ...
    if (paymentLink) {
      try {
        ...
        // Store selected plan for reference
    ...
    setOpening(false);
    // Continue to next step after opening payment link
  ...
  return (
    <div className="mx-auto px-2 py-2" style={{ maxWidth: 380, textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column' }}>
      <div style={{ marginBottom: 8 }}>
        <h2 style={{ color: 'rgba(255,255,255,0.94)', fontSize: 18, fontWeight: 800, marginBottom: 4 }}>
          Choose Your Plan
        </h2>
        <p style={{ color: 'rgba(255,255,255,0.65)', fontSize: 12, lineHeight: '16px' }}>
          Start with a plan that fits your needs. You can change anytime.
        </p>
      </div>
        ...
        <div style={{ 
          ...
          <button
            ...
            style={{
              ...
              background: billingCycle === 'monthly' ? 'rgba(59,130,246,0.8)' : 'transparent',
              border: 'none',
              cursor: 'pointer',
              transition: 'all 0.2s'
            }}
          ...
          <button
            ...
            style={{
              ...
              background: billingCycle === 'yearly' ? 'rgba(59,130,246,0.8)' : 'transparent',
              border: 'none',
              cursor: 'pointer',
              transition: 'all 0.2s'
            }}
          >
            ...
            <span style={{ 
              marginLeft: 4, 
              fontSize: 10, 
              color: billingCycle === 'yearly' ? '#86efac' : 'rgba(134,239,172,0.7)',
              fontWeight: 700
            }}>
              Save 17%
            </span>
      ...
      >
        Skip for now (limited free trial)
      </button>
    </div>
  );
}
